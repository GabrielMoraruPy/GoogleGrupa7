...
# requests_page = requests.get('https://www.bnr.ro/files/xml/nbrfxrates2021.htm')
requests_page = requests.get('https://www.bnr.ro/Cursul-de-schimb--7372.aspx')
print(requests_page)
link = BeautifulSoup(requests_page.text, 'html.parser')
dataset, header_list = [], []
